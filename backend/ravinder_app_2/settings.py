"""
Django settings for ravinder_app_2 project.
...
ROOT_URLCONF = 'ravinder_app_2.urls'
...
WSGI_APPLICATION = 'ravinder_app_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravinder_app_2 API",
    "DESCRIPTION": "API documentation for ravinder_app_2 App",
    "VERSION": "v1",
}
